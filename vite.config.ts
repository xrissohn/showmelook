  ...
  plugins: [
    ...
    /* PWA generation disabled while the former Workbox worker is retired. */ false && VitePWA({
      ...
      manifest: {
        name: "쇼미룩 - AI 패션 스타일링",
        short_name: "쇼미룩",
        description: "AI가 당신에게 딱 맞는 패션 스타일을 제안합니다",
        theme_color: "#a855f7",
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /^https:\/\/mggedvvzpwxlgrhatrau\.supabase\.co\/storage\/.*/i,
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          'vendor-ui': ['@radix-ui/react-dialog', '@radix-ui/react-dropdown-menu', '@radix-ui/react-tabs', '@radix-ui/react-tooltip', '@radix-ui/react-popover', '@radix-ui/react-accordion'],
