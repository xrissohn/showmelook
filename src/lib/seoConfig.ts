...
export const SEO_CONFIG: Record<string, PageSEO> = {
  ...
  cart: {
    title: '장바구니 | 쇼미룩',
    description: '쇼미룩 AI 스타일링으로 추천받은 옷과 아이템을 장바구니에 담고, 가격과 구매 링크를 한 번에 확인한 뒤 바로 주문하세요.',
  ...
  profileSetup: {
    ...
    description: '키·체형·선호 스타일과 예산을 입력하면 쇼미룩 AI가 나에게 어울리는 코디와 상품을 더 정확하게 추천해 드립니다.',
  ...
  notFound: {
    ...
    description: '요청하신 페이지를 찾을 수 없습니다. 홈으로 돌아가 쇼미룩의 AI 가상 피팅과 스타일 가이드를 둘러보세요.',
    canonical: `${BASE_URL}/`,
    ogImage: DEFAULT_OG_IMAGE,
    noindex: true,
  },
